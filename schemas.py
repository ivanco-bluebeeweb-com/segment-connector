"""Pydantic schemas for Segment Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Segment.")
    api_token: str = Field(description="Access Token / API Key")
    base_url: str = Field(default="https://api.segmentapis.com", description="Segment API base URL.")
...
class GetAudienceParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    audience_id: str = Field(description="Segment Audience ID.")
